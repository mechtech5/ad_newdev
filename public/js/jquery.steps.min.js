...
! function (a, b) {
	...
	function J(b, c, d) {
		var e = '<{0} class="{1}">{2}</{0}>',
			...
			i = a(e.format(c.stepsContainerTag, "steps " + c.clearFixCssClass, '<ul role="tablist" class="nav nav-tabs"></ul>')),
	...
	function L(a, b, c) {
		if (b.enablePagination) {
			var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}" class="nav navbar-nav" >{3}</ul></{0}>',
