			...
			<div class="col-md-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="">Create Specialization Subcategory <a href="{{route('spec_subcategory.index')}}" class="btn btn-sm btn-primary pull-right">Back</a></h3>
					</div>
					<div class="box-body" id="subcategory">
						<form action="{{route('spec_subcategory.store')}}" method="post">
							@csrf
							...
							<div class="row form-group">
								<div class="col-md-6">
									...
									<input type="text" name="subcatg_desc" class="form-control" placeholder="Enter Subcategory Name" value="{{old('subcatg_desc')}}">
									@error('subcatg_desc')
										<span class="text-danger">
											<strong>{{$message}}</strong>
										</span>
								...
								<div class="col-md-6">
									...
									<input type="text" name="short_desc" class="form-control" placeholder="Enter Subcategory Short Name" value="{{old('subcatg_desc')}}">
									@error('short_desc')
										<span class="text-danger">
											<strong>{{$message}}</strong>
										</span>
