			...
			<div class="col-md-12">
				<div class="box box-primary">
					...
					<div class="box-body" id="subcategory" >					
						<form action="{{route('qual_subcategory.store')}}" method="post">
							@csrf
							<div class="row form-group">
								<div class="col-md-6">
									...
									<select class="form-control" name="qual_catg_code">
										...
										@foreach($quali as $qual)
											<option value="{{$qual->qual_catg_code}}" {{old('qual_catg_code') == $qual->qual_catg_code ? 'selected' : ''}}>{{$qual->qual_catg_desc}}</option>
										@endforeach 
									</select>
								...
								<div class="col-md-6">
									...
									<input type="text" name="qual_desc" class="form-control" placeholder="Enter Subcategory Name" value="{{old('qual_desc')}}">
									@error('qual_desc')
										<span class="text-danger">
											<strong>{{$message}}</strong>
										</span>
